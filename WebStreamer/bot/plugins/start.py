        ...
        if Var.UPDATES_CHANNEL is not None:
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="Sorry Sir, You are Banned to use me. Contact my [Developer](https://t.me/MrNobody_Here).",
                        parse_mode="markdown",
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="Something went Wrong. Contact my [Developer](https://t.me/MrNobody_Here).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
                        ...
                        [
                            ...
                            [
                                InlineKeyboardButton("🔄 Refresh / Try Again",
                                                     url=f"https://t.me/File2LinkPro_Bot?start=MrNobody_Here_{usr_cmd}")
                            ]
                        ]
                    ),
                    parse_mode="markdown"
...
async def help_handler(bot, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Channel", url="https://t.me/Nobodys_Bots"), 
                InlineKeyboardButton("Developer", url="https://t.me/MrNobody_Here")]
            ]
        )
    )
